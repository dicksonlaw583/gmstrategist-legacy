///mcts_trial_play(ruleset, configs, text_gameset, max_playout_plies, max_playout_ms, max_eval_playouts, max_eval_ms, ai_output, ai_verbose)
/**
  ...
  do {
    ...
    while (!script_execute(ruleset[RULESET.SCR_IS_FINAL], state)) {
      ...
      if (is_undefined(current_player)) {
        var move = script_execute(ruleset[RULESET.SCR_GENERATE_RANDOM], state);
      } else {
